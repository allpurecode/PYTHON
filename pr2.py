...
l3 = Label(root, text='Vs', font=('algerian', 35))
...
paper_p = Image.open((300, 300))
paper_c = paper_p.transpose(Image.FLIP_LEFT_RIGHT)
paper_p = ImageTk.PhotoImage(rock_p)
paper_c = ImageTk.PhotoImage(rock_p)
...
img_s = Image.open("selcection.jpeg")
